...
Customization of wooCommerce plugins using hooks like remove shipping address from checkout rename add to cart button different -2 based on products etc and anything you want to make changes in wooCommerce you can use this plugins and make changes.You ucan make changes in wooCommerce plugins without editing its core files. 
...
This is shortcode based small plugins you can make chages by editing this. I mostly used the wooCommerce hooks to modified the wooCommerce plugins.
